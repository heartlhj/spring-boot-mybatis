//////////////////////////////////////////
//gogoingSoft corp. 2016-03-01
//Author :yu.xiao
//commits:数据列表
//////////////////////////////////////////

//类定义
gogoing.Package("gogoing");

gogoing.DataGrid = function(dataGridId, initParam,disableEdit) {
...
//			if(!gogoing.IsNull(height) && pHeight < height){
...
//			alert("宽度：" + width);
		...
		//编辑单元格事件失去焦点回调
		if(!gogoing.IsNull(savesuccessfunc)){
